...
and _menhir_goto_operator_expression : _menhir_env -> 'ttv_tail -> _menhir_state -> (Syntax.expression) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    match _menhir_s with
    | MenhirState91 | MenhirState83 | MenhirState81 | MenhirState74 | MenhirState71 | MenhirState64 | MenhirState13 | MenhirState51 | MenhirState49 | MenhirState47 | MenhirState45 | MenhirState43 | MenhirState41 | MenhirState39 | MenhirState37 | MenhirState35 | MenhirState33 | MenhirState31 | MenhirState29 | MenhirState27 | MenhirState14 ->
        let _menhir_stack = Obj.magic _menhir_stack in
    ...
    | MenhirState12 ->
        ...
        | RIGHT_ROUND_BRACKET ->
            ...
            | LEFT_CURLY_BRACKET ->
                ...
                (match _tok with
                | ID _v ->
                    _menhir_run90 _menhir_env (Obj.magic _menhir_stack) MenhirState61 _v
                | IF ->
        ...
        | RIGHT_CURLY_BRACKET ->
            ...
            | ELSE ->
                ...
                | LEFT_CURLY_BRACKET ->
                    ...
                    (match _tok with
                    | ID _v ->
                        _menhir_run90 _menhir_env (Obj.magic _menhir_stack) MenhirState96 _v
                    | IF ->
...
and _menhir_goto_expression : _menhir_env -> 'ttv_tail -> _menhir_state -> (Syntax.expression) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState12 | MenhirState86 | MenhirState54 | MenhirState19 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        (match _tok with
    ...
    | MenhirState13 ->
        ...
        _menhir_goto_operator_expression _menhir_env _menhir_stack _menhir_s _v
    | MenhirState91 | MenhirState81 | MenhirState64 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        (match _tok with
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState64 ->
        ...
        | SEMI_COLLON ->
            ...
            (match _tok with
            | ID _v ->
                _menhir_run90 _menhir_env (Obj.magic _menhir_stack) MenhirState70 _v
            | IF ->
