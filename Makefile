...
all_tests:
	...
	@echo "Result:";
	@printf "\n";
	@cat tests/test6.txt | ./exp_test.native;
	@printf "\n";
	@echo "Test7:";
	@printf "\n";
	@cat tests/test7.txt;
	@echo "Result:";
	@printf "\n";
	@cat tests/test7.txt | ./exp_test.native;
	@printf "\n";
	@echo "Test8:";
	@printf "\n";
	@cat tests/test8.txt;
	@echo "Result:";
	@printf "\n";
	@cat tests/test8.txt | ./exp_test.native;
	@printf "\n";
	@echo "Test9:";
	@printf "\n";
	@cat tests/test9.txt;
	@echo "Result:";
	@printf "\n";
	@cat tests/test9.txt | ./exp_test.native;
	@printf "\n";
	@echo "Test10:";
	@printf "\n";
	...
	@echo "Result:";
	@printf "\n";
	@cat tests/test10.txt | ./exp_test.native;
	@printf "\n";
